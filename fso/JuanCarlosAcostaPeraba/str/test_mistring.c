...
#ifndef TEST
#include "lib/mi_string/mi_string.h"
#endif
...
/**
 * @brief Test de mi_strcpy
 */
void test_mi_strcpy()
{
    char cadena[10] = "hola mundo";
    char cadena_copia[10];
    INICIO_TEST("mi_strcpy");
    mi_strcpy(cadena_copia, cadena);
    DebeSerCierto(mi_strequals(cadena, cadena_copia));
    FIN_TEST("mi_strcpy");
}

/**
 * @brief Test de mi_strcat
 */
void test_mi_strcat()
{
...
/**
 * @brief Test de mi_strdup
 */
void test_mi_strdup()
{
    char *cadena1 = "hola mundo";
    char *cadena2 = "hello world";
    char *resultado = mi_strdup(cadena1);
    INICIO_TEST("mi_strdup");
    DebeSerCierto(mi_strequals(cadena1, resultado));
    DebeSerFalso(mi_strequals(cadena2, resultado));
    free(resultado);
    FIN_TEST("mi_strdup");
}

/**
 * @brief Test de mi_strequals
 */
void test_mi_strequals()
{
    INICIO_TEST("mi_strequals");
    DebeSerCierto(mi_strequals("hola mundo", "hola mundo"));
    DebeSerFalso(mi_strequals("hola mundo", "hello world"));
